...
resourcestring
  ...
  FORM_CAPTION_LOAD_REGISTRY                      = 'レジストリ';
	...
	BASIC_PANEL_CHECKBOX_WINDOW_MINIMAIZE           = '常にウィンドウを最小化して処理する(&Z)';
	BASIC_PANEL_CHECKBOX_TASKBAR_HIDE               = 'ウィンドウを最小化したときタスクバーに表示しない(&H)';
	BASIC_PANEL_CHECKBOX_TASKTRAY_ICON              = 'タスクトレイにアイコンを表示する(&C)';
