...
resourcestring
  ...
  LABEL_STATUS_TITLE_ENCRYPT_START          = '暗号化の処理を開始しました...';
  LABEL_STATUS_TITLE_DECRYPT_START          = '復号処理を開始しました...';
  LABEL_STATUS_TITLE_COMPARE_START          = 'コンペアを開始しました...';
  ...
  LABEL_STATUS_DETAIL_ENCRYPT_COMPLETED     = '暗号化の処理は完了しました。';
  LABEL_STATUS_DETAIL_DECRYPT_COMPLETED     = '復号処理は完了しました。';
  LABEL_STATUS_DETAIL_DELETE_COMPLETED      = '削除処理は完了しました。';
  ...
  LABEL_STATUS_DETAIL_FAILED_DELETE         = '削除処理に失敗しました。';
