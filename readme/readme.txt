======================================================================
アタッシェケース    ver.2.8.0.4β     2012/09/20
...
ver.2.8.0.4β  2012/09/20
              ...
              ・暗号/復号処理後の削除処理がうまく行っていない？　要調査。
              ・連続処理の検証をもう少し行う。
              ・バッチ処理の際にエラーが発生してもそれを無視する
               オプションを 追加し、また、それをログとして残せる機能の
               追加を検討（ユーザーさんからのご要望）。
               （ひょっとしたら実装は次のバージョンになるかもしれません）。
