...
initialization
	...
	BUTTON_CAPTION_DECRYOTION;
	BUTTON_CAPTION_CANCEL;
	BUTTON_CAPTION_EXIT;
	BUTTON_CAPTION_HELP;

	CHECK_BOX_SAVE_TO_OTHER_DIRECTORY;
	DIALOG_MSG_SELECT_SAVE_TO_FOLDER;

	LABEL_CAPTION_ABOUT;
	LABEL_CAPTION_SELECT_DECRYPTION_FOLDER;
	LABEL_CAPTION_INPUT_PASSWORD;
	...
	FORM_ABOUT_CAPTION;
	FORM_ABOUT_LABEL_CAPTION_DESCRIPTION_01;
	FORM_ABOUT_LABEL_CAPTION_DESCRIPTION_02;
	FORM_ABOUT_LABEL_CAPTION_DESCRIPTION_03;
	FORM_ABOUT_LABEL_WEB_SITE_URL;
